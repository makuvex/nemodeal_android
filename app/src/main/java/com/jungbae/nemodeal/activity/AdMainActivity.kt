...
import kotlinx.android.synthetic.main.activity_ad_main.*
...
class AdMainActivity : AppCompatActivity() {
    ...
    private fun refreshAd() {
        ...
        builder.forUnifiedNativeAd { unifiedNativeAd ->
            ...
            Log.e("@@@","@@@ forUnifiedNativeAd $unifiedNativeAd")
        ...
        val adLoader = builder.withAdListener(object : AdListener() {
            override fun onAdFailedToLoad(errorCode: Int) {
                refresh_button.isEnabled = true
                Toast.makeText(this@AdMainActivity, "Failed to load native ad: " + errorCode, Toast.LENGTH_SHORT).show()
            }
